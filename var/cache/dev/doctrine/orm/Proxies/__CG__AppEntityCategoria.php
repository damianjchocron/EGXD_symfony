...
class Categoria extends \App\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Categoria' . "\0" . 'idcategoria', '' . "\0" . 'App\\Entity\\Categoria' . "\0" . 'nombrecategoria', '' . "\0" . 'App\\Entity\\Categoria' . "\0" . 'url'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNombrecategoria(string $nombrecategoria): \App\Entity\Categoria
    {
     ...
     * {@inheritDoc}
     */
    public function setUrl(?string $url): \App\Entity\Categoria
    {
