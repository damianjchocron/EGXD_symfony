...
class __TwigTemplate_854918b32ecf6b362c255b4de9f0879db13d154dc594e6e28ca1305188494096 extends Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
\t\t<div class=\"form-group inputFiles m-3\">
\t\t\t<label class=\"col-12 mt-3\" for=\"image\">Imagenes, la primera sera la Predefinida.</label>
\t\t\t<button type=\"button\" class=\"btn-primary btn m-3\" id=\"btnAdd\">Agregar Foto</button>
\t\t\t<div class=\"mt-3\">
\t\t\t\t<input type=\"file\" id=\"image\" class=\"form-control\" name=\"fichero[]\" aria-describedby=\"fichero\" placeholder=\"Fichero\">
\t\t\t</div>
\t\t</div>
\t\t<input type=\"submit\" class=\"btn btn-success m-3\" name=\"submit\" value=\"Insertar Producto\"/>
\t</form>
";
...
";
    ...
    {
        return array (  189 => 49,  179 => 48,  150 => 28,  139 => 26,  135 => 25,  125 => 17,  119 => 14,  116 => 13,  113 => 12,  103 => 11,  91 => 7,  81 => 6,  61 => 3,  38 => 1,);
    }
