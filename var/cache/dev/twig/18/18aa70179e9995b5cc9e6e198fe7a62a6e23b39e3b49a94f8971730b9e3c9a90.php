...
class __TwigTemplate_2f6099155d90bdd9154fccebd46eb92944cea39ee62c12fb0628d2b57a85a58d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["productRepo"]) || array_key_exists("productRepo", $context) ? $context["productRepo"] : (function () { throw new RuntimeError('Variable "productRepo" does not exist.', 81, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 86
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("detailProduct", ["idproduct" => twig_get_attribute($this->env, $this->source, $context["value"], "idproduct", [], "any", false, false, false, 86)]), "html", null, true);
            echo "\" title=\"";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img class=\"img-card\" src=\"";
            // line 87
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "url", [], "any", false, false, false, 87), "html", null, true);
            echo "\" alt=\"";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"card-title\">";
            // line 95
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "titulo", [], "any", false, false, false, 95), "html", null, true);
            echo "</h2>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"price\">U";
            // line 101
            echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(twig_get_attribute($this->env, $this->source, $context["value"], "precio", [], "any", false, false, false, 101), "USD"), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t</div>
    ...
    {
        return array (  316 => 176,  311 => 172,  308 => 170,  303 => 166,  300 => 164,  295 => 160,  292 => 158,  287 => 154,  284 => 152,  279 => 148,  275 => 145,  270 => 141,  267 => 139,  262 => 135,  259 => 133,  254 => 129,  234 => 110,  219 => 101,  210 => 95,  197 => 87,  191 => 86,  185 => 82,  180 => 81,  175 => 77,  163 => 66,  154 => 58,  148 => 53,  143 => 49,  139 => 46,  135 => 43,  131 => 40,  128 => 39,  126 => 38,  118 => 31,  113 => 27,  108 => 23,  104 => 20,  100 => 17,  96 => 14,  89 => 8,  79 => 7,  59 => 2,  36 => 1,);
    }
...
", "home/indexNEW.html.twig", "C:\\xampp\\htdocs\\Ejercicios\\damian\\EGXD_symfony\\templates\\home\\indexNEW.html.twig");
    }
}
